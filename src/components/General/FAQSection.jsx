      ...
      <div className="w-full max-w-4xl mx-auto !px-6">
        ...
        <div className="max-w-4xl mx-auto text-center !mb-12 lg:!mb-20 flex flex-col justify-center items-center">
          ...
          <p className="font-medium text-gray-400 text-sm sm:text-lg !px-4 sm:!px-8 leading-relaxed mx-auto">
            Got questions? We've got answers. Here's everything you need to know to get started with SimJob and ace your next interview.
          </p>
        </div>
          ...
          {faqs.map((faq, index) => (
            <div
              ...
              className={`group bg-white/70 backdrop-blur-sm border border-white/20 rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 overflow-hidden ${
                openIndex === index ? 'ring-2 ring-blue-500/20 shadow-blue-100' : ''
              }`}
            >
              <button
                className="w-full flex justify-between items-center !p-4 text-left group-hover:bg-white/50 transition-colors duration-300"
                onClick={() => toggleFAQ(index)}
              >
                <span className="font-light text-lg text-gray-900 !pr-8 group-hover:text-blue-700 transition-colors duration-300">
                  {faq.question}
                </span>
                <div className={`flex-shrink-0 w-10 h-10 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full flex items-center justify-center transition-all duration-500 ${
        ...
        <div className="text-center !mt-16">
          ...
          <button className="inline-flex items-center !px-8 !py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-full hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer" onClick={()=>navigate('/contactus')}>
