        ...
        <div className="container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              Master Your <span className="gradient-text">Interview Skills</span> with AI-Powered Mock Interviews
            </h1>
            <p className="hero-subtitle">
              Practice real-time interviews with our advanced AI system and get company-specific online assessments. 
              Build confidence and land your dream job.
            </p>
            <div className="hero-buttons">
              {/* <button className="btn btn-primary btn-large" onClick={() => setIsAuthOpen(true)}>
                <span>Start Free Trial</span>
                <svg className="btn-icon" viewBox="0 0 24 24" fill="none">
                  <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </button> */}
              <CTAButton onclick={() => token ? navigate('/interview') : navigate('/login')} btnText={"Start Now"}/>
                  ...
                  <div className="interview-simulation">
                    <div className="ai-interviewer">
                      ...
                      <div className="message-bubble">
                        <p>"Tell me about your experience with React and how you've used it in previous projects..."</p>
